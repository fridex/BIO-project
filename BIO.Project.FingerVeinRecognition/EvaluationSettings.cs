...
namespace BIO.Project.FingerVeinRecognition
{
    ...
    > {
        ...
        public EvaluationSettings() {
            this.addBlockToEvaluation(new VeinBiometricSystem.VeinProcessingBlockComponents3("Alg1").createBlock());
            this.addBlockToEvaluation(new VeinBiometricSystem.VeinProcessingBlockComponents4("Alg2").createBlock());
            this.addBlockToEvaluation(new VeinBiometricSystem.VeinProcessingBlockComponents1("Alg3").createBlock());
            this.addBlockToEvaluation(new VeinBiometricSystem.VeinProcessingBlockComponents2("Alg4").createBlock());
